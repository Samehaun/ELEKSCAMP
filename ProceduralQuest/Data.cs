...
namespace ProceduralQuest
{
    ...
    static class Data
    {
        public static double PoisonHPRegenModifier = -1;
        public static double PoisonStaminaRegenMidifier = 0.8;
        public static double PoisonStaminaConsumtionModifier = 1.07;
        public static double BleedingHPRegenModifier = -2;
        public static double BleedingStaminaRegenMidifier = 0.8;
        public static double BleedingStaminaConsumtionModifier = 1.3;
        public static double InjuredStaminaConsumtionModifier = 1.5;
        public static double InjuredSpeedModifier = 0.2;
        public static double HungerHPRegenModifier = -0.3;
        public static double HungerStaminaRegenMidifier = 0.9;
        public static double HungerStaminaConsumtionModifier = 1.03;
        ...
        public static string StateBuilder(Player player, string languageSettings)
        {
            ...
            {
                case "EN":
                    return $"Player {player.Name} has {player.HP} hp";
                case "RU":
                    return $"У {player.Name} {player.HP} хп";
                case "UA":
                    return $"У {player.Name} {player.HP} хп";
                default:
                    return $"Wrong language settings";
