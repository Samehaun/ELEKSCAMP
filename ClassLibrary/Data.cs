...
namespace ELEKSUNI
{
    ...
    static class Data
    {
        private static Dictionary<Keys, string> enText = new Dictionary<Keys, string>()
        {
            ...
            {Keys.Knife, "Knife" },
            {Keys.SharpKnife, "Sharp knife" },
            {Keys.OldAxe, "Old axe" },
            {Keys.Axe, "Axe" },
            {Keys.Remains, "You have " },
            {Keys.Loot, "Loot" },
            {Keys.Witch, "Witch" },
            {Keys.Forester, "Forester" },
            {Keys.Leprechaun, "Leprechaun" },
            {Keys.Wolf, "Wolf" },
            {Keys.Bear, "Bear" },
            {Keys.Steal, "Steal"},
            {Keys.Fight, "Fight"},
            {Keys.Run, "Run"},
            {Keys.Found, "You have found "},
            {Keys.NotFound, "You didn't find anything interesting"},
            {Keys.Trap, "You have triggered a trap! Managed to get out but injured"},
            {Keys.HornetNest, "Ouch! You disturbed a hornet nest got a lot of stings"},
            {Keys.Cure, "Bottle of strong antidote"},{Keys.Bondage, "Bondage"},
            {Keys.CurePoison, "You are feeling better"},{Keys.StopBleeding, "It still hurts, but bleeding is stopped"},
        ...
        private static Dictionary<Keys, string> ruText = new Dictionary<Keys, string>()
        {
            ...
            {Keys.Buy, "Купить" },
            {Keys.Sell, "Продать" },
            {Keys.Trade, "Торговать" },
            {Keys.Search, "Обследовать" },
            {Keys.Bleeding, "кровотечение" },
            {Keys.Poison, "отравление" },
            {Keys.Injure, "травма" },
            {Keys.Sturve, "голод" },
            {Keys.Cold, "обморожение" },
            {Keys.North, "Север"},
            {Keys.South, "Юг"},
            {Keys.East, "Восток"},
            {Keys.West, "Запад"},
        ...
        private static Dictionary<Keys, string> uaText = new Dictionary<Keys, string>()
        {
            ...
            {Keys.Trade, "Trade" },
            {Keys.Search, "Search" },
            {Keys.Bleeding, "bleeding" },
            {Keys.Poison, "poisoned" },
            {Keys.Injure, "injured" },
            {Keys.Sturve, "sturving" },
            {Keys.Cold, "freeze" },
            {Keys.North, "Північ"},
            {Keys.South, "Південь"},
            {Keys.East, "Схід"},
            ...
            {Keys.Rest, "Відпочити"},
            {Keys.Sleep, "Спати"},
            {Keys.NightTime, "Занадто темно задля подорожі"},
            {Keys.RestNeeded, "Ви надто втомилися, потрібен відпочинок"},
            {Keys.NextZone, "Ви дісталися наступної зони"},
            {Keys.DirectionDialogMessage, "Оберіть напрямок"},
